      ...
      <Wrapper>
        <section className="w-full mt-10">
          ...
          <div className="flex flex-col gap-6">
            {/* <div className="max-w-11/12 md:w-full md:max-w-full flex justify-center mx-auto">
              <span className="text-2xl text-center font-bold text-gray-300">Mais de {animatedNumber(count)} Células</span>
            </div> */}
            {/* FILTERS */}
          ...
          {/* PAGINAÇÃO */}
          <div className={`${styles.customScroll} max-w-sm overflow-x-auto flex justify-start mt-10 mb-20 gap-2 md:max-w-md mx-auto`}>
